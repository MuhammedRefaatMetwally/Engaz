...
import com.example.engaz.features.transactions.view.components.CustomSearchBar
import com.example.engaz.features.transactions.view.components.PlaceItem
import com.example.engaz.features.transactions.view.viewmodel.select_location.SelectLocationState
...
@Preview
@Composable
fun SearchLocationFromScreenPreview() {
    MarketAppTheme {
